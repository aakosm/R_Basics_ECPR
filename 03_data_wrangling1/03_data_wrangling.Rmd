...
```{r}
wide_df <- read.csv("https://www.dropbox.com/s/009zu3nngpabo4k/wide_df.csv?dl=1")
```
...
> **Excercise:**  
(1) load a data set on financial data of Microsoft and Tesla from this link: "https://www.dropbox.com/s/xws0hwat50pq62r/stock_data.csv?dl=1".  
...
Solution:
```{r echo=FALSE}
stock_df <- read_csv("https://www.dropbox.com/s/xws0hwat50pq62r/stock_data.csv?dl=1")
...
> Quick excercise:  
(1) load additional data from "https://www.dropbox.com/s/7jzdu4zgrvdezay/stock_data2.csv?dl=1" and perform the same reshaping with the `gather()` function as before.  
