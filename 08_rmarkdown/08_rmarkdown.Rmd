...
A quick example of what a possible article written in RMarkdown looks like is here: [https://github.com/aakosm/rmarkdown_workshop/blob/master/rmd_example/ex2.pdf](https://github.com/aakosm/rmarkdown_workshop/blob/master/rmd_example/ex2.pdf) The example article is based on the post of [Kieran Healy: Plain text, papers, pandoc](https://kieranhealy.org/blog/archives/2014/01/23/plain-text/) (click if you
want to dig deeper).
